...
**État du projet** : V1 livrée et fonctionnelle (phases 0-13). Cycle V2 ouvert le 26/05/2026. **VAGUE 0 fermée le 27/05/2026 (nuit)** : V2.0.1-0.3 (préséance, CSP, fondations UI). **VAGUE 1 fermée le 27/05/2026 (nuit)** : V2.1.1 retrait wallet ; V2.1.2 Consentement ; V2.1.3 Droit atomique. **VAGUE 2 fermée le 27/05/2026 (nuit)** : V2.2.1 FilDeGroupe (composant transversal §18) ; V2.2.2 Réservation réutilisable (D8) ; V2.2.3 Caisse + reversements (D7/D12/D12bis justificatif obligatoire) ; V2.2.4 Open Graph côté serveur (§10, 4 pages branchées : pétition, cagnotte, mobilisation, moment_solidaire). 373 tests verts. **6 migrations posées localement à appliquer au matin** (`supabase db push`) : `20260527000000_t99cp_hash_consomme.sql`, `20260527010000_consentement.sql`, `20260527020000_droit.sql`, `20260527030000_fil_groupe.sql`, `20260527040000_reservation.sql`, `20260527050000_caisse.sql`. Puis lancer `scripts/backfill-consentement.ts` puis `scripts/backfill-droits.ts` (`--dry-run` puis `--confirm`). Par ailleurs, **PR CI workflow** en cours via Ultraplan (session https://claude.ai/code/session_01RJgX8KDziBSrCzdMYS8zv1) qui ajuste `.github/workflows/ci.yml` (Chromium seul en CI + cron mensuel cross-browser + vars Supabase). Chantiers 7.3/7.6 toujours en stubs fonctionnels honnêtes. Chantier 2.2 (8 pages éditoriales) bloqué tant que les textes ne sont pas fournis. VAGUE 3 (nouveaux sous-espaces S'entraider hébergement/transport/prêt/marché/groupe d'entraide local, location mutualisée, compléments S'informer/Agir) attend autorisation explicite + arbitrages de Lilou/Ben pour les contenus.
