...
**Dernière mise à jour** : 2026-05-27 (nuit, suite VAGUE 3 finitions — 34 chantiers consécutifs V2.3.13→V2.3.46)
**Dernier chantier terminé** : V2.3.46 (tests unitaires des helpers purs filtres + compter-membres) — 14 nouveaux tests, total 427 verts.
