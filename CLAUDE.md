...
**Dernier chantier terminé** : 7.1 — Maintenant Médias (table polymorphe 9 types + page liste 10 onglets + fiche détail avec embed audio/vidéo/iframe) (voir `docs/manifests/phase-7-chantier-7.1.md`)
**Chantier en cours** : 7.2 (Maintenant Radio AzuraCast) ou 2.2 (pages éditoriales)
