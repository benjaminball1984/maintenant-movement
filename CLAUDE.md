...
**Dernier chantier terminé** : 8.1 — Notifications (table + préférences par canal et par type + service centralisé `declencherNotification` + Server Actions préférences) (voir `docs/manifests/phase-8-chantier-8.1.md`)
**Chantier en cours** : 9.1 (Console modération unique) ou 2.2 (pages éditoriales)
