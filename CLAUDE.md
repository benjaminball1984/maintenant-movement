...
**Dernier chantier terminé** : 7.4 — Sondages (2 modes + 1 vote par personne + sociodémo optionnels + résultats agrégés) + stubs explicites 7.3 (journal-affiche), 7.5 (réseau social), 7.6 (Décider) (voir `docs/manifests/phase-7-chantier-7.3-7.4-7.5-7.6.md`)
**Chantier en cours** : 8.1 (Notifications) ou 2.2 (pages éditoriales)
