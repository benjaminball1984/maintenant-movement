...
**Dernière mise à jour** : 2026-06-13 (session jour : V2.6.108 regroupement carte, V2.6.109 édition admin de tous les contenus média, V2.6.110 vraie photo d'Antoine Miko sur le sondage présidentielle, V2.6.111 mosaïque de couverture auto des sondages [déployé, commit 1ce9dcc], V2.6.112 éditeur d'options ligne par ligne (nom + image par option, bouton « + ») [déployé], V2.6.113 dédup vidéo/brève + catégories de la revue de presse [déployé, commit 3affea3], V2.6.114 texte des contenus + faux « lives » + catégories revue de presse [données prod corrigées, code à déployer] ; tout en ligne sur maintenant-le-mouvement.org, commits locaux sur la branche `feature/phase-0-chantier-0.1-deploiement-cloudflare`, non poussés sur GitHub sur la branche `feature/phase-0-chantier-0.1-deploiement-cloudflare`, non poussés sur GitHub)
