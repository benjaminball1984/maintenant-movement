...
**Dernière mise à jour** : 2026-05-29 (cycle V2.5.23→V2.5.28 : rich text complet + logo officiel intégré)
**Dernier chantier terminé** : V2.5.28 (tests sécurité `sanitizeRichHtml` — 18 tests d'allowlist positive et négative anti-XSS) — sur `main` (tip `526d9cd`). 975 tests verts (957 + 18).
