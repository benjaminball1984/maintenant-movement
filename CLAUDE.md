...
**Dernière mise à jour** : 2026-05-29 (V2.5.56 : centralisation des formatteurs de date inline vers `lib/format-date.ts`)
**Dernier chantier terminé** : V2.5.56 (centralisation formatteurs de date) : sur `main` (tip `__TIP__`). 2 nouveaux helpers (`formaterDateMoyenne`, `formaterDateLongueHeure`) + 12 pages migrées (32 sites d'appel), formats identiques garantis. 3 tests ajoutés (1005 verts). Voir `docs/manifests/v2-5-56-centralisation-formatteurs-date.md`.
