...
**Dernier chantier terminé** : 5.3 — Moments solidaires (8 types + porte-à-porte 7 RDV automatiques + tracker Tupperwares + flyer sans inclusive) (voir `docs/manifests/phase-5-chantier-5.3.md`)
**Chantier en cours** : 5.4 (D'autres moyens d'agir) ou 2.2 (pages éditoriales)
