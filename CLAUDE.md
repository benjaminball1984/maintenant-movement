...
**Dernier chantier terminé** : 7.2 — Maintenant Radio (player AzuraCast natif HTML5 + métadonnées now-playing + état stub honnête tant que le serveur n'est pas posé) (voir `docs/manifests/phase-7-chantier-7.2.md`)
**Chantier en cours** : 7.4 (Sondages) ou 2.2 (pages éditoriales)
